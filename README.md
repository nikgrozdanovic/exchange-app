...
Before launching the app, in order to test mail sending change your `env` file and put your own [Mailtrap](https://mailtrap.io/)  (lines 26-33) `.env` file. parameters.
